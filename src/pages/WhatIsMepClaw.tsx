...
const rows = [
  ...
  },
  {
    ...
    body: "Your customer and job history belong entirely to you, free from restrictive licensing. At the center of MEP Claw is a self-hosted instance of CRM, safely managing nearly a thousand rows of rich customer profiles, job scopes, individual visits, and communication history within your private network.",
  ...
  },
  {
    ...
    body: "Clean up your company's camera rolls automatically. When technicians upload job site photos to Discord, the field-ops engine passes them to a self-hosted Photos photo server. The system automatically categorizes and organizes the images into dedicated visual albums linked to the customer's physical service address.",
    visualLabel: "Photos photo routing",
  },
  {
    eyebrow: "AI built in",
