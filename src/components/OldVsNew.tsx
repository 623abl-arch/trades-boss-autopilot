const rows = [
  ...
  },
  {
    ...
    newTitle: "Geotagged Photo Vault",
    newBody:
      "Your photo library automatically tags job photos and pins them onto a visual map by service address. Pull up any property to see its entire visual history instantly.",
  },
  {
